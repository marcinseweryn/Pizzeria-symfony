...
class OrderStatusController extends Controller{
    ...
    /**
     * @Route("user/order-status", name="user-order-status")
     */
    public function generateView(Request $request){
        ...
        $orders = $em->getRepository(Order::class)->findOrdersInProgressByUserID($userID);
        if($orders != NULL){
        ...
        return $this->render('user/order-status.html.twig',
